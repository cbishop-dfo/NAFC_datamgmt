...
os.environ['PROJ_LIB'] = r'C:\Users\BISHOPC\Anaconda3\envs\OxyCalPfiles_p27\Library\share'
from mpl_toolkits.basemap import Basemap
...
#direc = "C:\ctd\DO2CAL\python_sample"
shiptrip = "79002"
direc = "C:/Working_Documents/ctd/DO2CAL/"+shiptrip+"cal"
os.chdir(direc)
#root.destroy()
...
newmasterdf = masterwinddf[['STATION NAME','DATE (yyyy-mm-dd)','TIME UTC','ShTrpStn FILENAME','STICKER NUMBER','LATITUDE DEGREES','LATITUDE MINUTES','LONGITUDE DEGREES','LONGITUDE MINUTES','PRESSURE','T-90 (oC)','SALINITY','SIGMA-T','DO2','DO2 SATURATION','DO2 %SATURATION','FIECO-AFL','PAR','PH','WetCDOM','CStarAt0','CStarTr','WindDirection','WindSpeed_kts','WindSpeed_m/s']].copy()
